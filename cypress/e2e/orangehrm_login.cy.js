describe('Scenario Login OrangeHRM', () => {
  ...
  // TEST CASE 009
  it('TC 009 - Login dengan username kosong, sementara password valid', () => {
    // buka halaman orangehrm login
    cy.visit('https://opensource-demo.orangehrmlive.com/web/index.php/auth/login')
  ...
  // TEST CASE 010
  it('TC 010 - Login dengan password kosong, sementara username valid', () => {
    // buka halaman orangehrm login
    cy.visit('https://opensource-demo.orangehrmlive.com/web/index.php/auth/login')
  ...
  // TEST CASE 011
  it('TC 011 - Login dengan username kosong, dan password tidak valid', () => {
    // buka halaman orangehrm login
    cy.visit('https://opensource-demo.orangehrmlive.com/web/index.php/auth/login')
